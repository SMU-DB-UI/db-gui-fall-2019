...
class Loginscreen extends Component {
  constructor(props){
    ...
    loginButtons.push(
      ...
      <MuiThemeProvider>
        <div>
           <RaisedButton label={"Register an Employee"} primary={true} style={style} onClick={(event) => this.handleClick(event,'student')}/>
       </div>
       </MuiThemeProvider>
       <MuiThemeProvider>
       <div>
          <RaisedButton label={"Register as HR"} primary={true} style={style} onClick={(event) => this.handleClick(event,'teacher')}/>
      </div>
      </MuiThemeProvider>
      </div>
    )
    this.state={
      ...
      studentbuttonLabel:'Register as an Employee',
      teacherbuttonLabel:'Register as HR',
      isLogin:true
    }
  }
  componentWillMount(){
  ...
  handleClick(event,userRole){
    ...
    if(this.state.isLogin){
      ...
      loginButtons.push(
        ...
        <MuiThemeProvider>
          <div>
             <RaisedButton label={"Register as an Employee"} primary={true} style={style} onClick={(event) => this.handleClick(event,'student')}/>
         </div>
         </MuiThemeProvider>
         <MuiThemeProvider>
         <div>
